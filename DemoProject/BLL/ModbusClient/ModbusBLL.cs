...
namespace BLL.ModbusClient
{
    ...
    {
        private BaseSerial Serial = null;
        public List<ushort> TagValueList = null;
        private BaseTCP TCPClient = null;

        public bool PortConnect(string PortName, string BuadRate, string DataBit, string Parity, string StopBit)
        {
        ...
        public bool PortConnect(string IP, int Port)
        {
        ...
        public void TCPDataWrite(int DeviceNum, string RegisterType, ushort StartBit, ushort Length)
        {
            if (TCPClient != null)
            {
        ...
        private void TCPDatarecieved()
        {
            Task.Run(async () =>
            {
                await TCPClient.StartListen(100);
            });
        }

        public void SerialDataWrite(int DeviceNum,string RegisterType,ushort StartBit,ushort Length)
        {
            if (Serial != null)
            {
                byte DN = Convert.ToByte(DeviceNum);
